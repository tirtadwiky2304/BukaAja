...
const textWa = "You always be mine, I love you too"
const pesan = `Gatau mau ngomong apa, cuman mau bilang terimakasih udah hadir di hidup aku buat yg kedua kalinya walaupun situasi kita berbeda dengan dulu, but i just wanna say I love you`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama Kamu, Tar muncul sesuatu`)
      }
      return { login }
    }
  }).then((result) => {
